 ...
 * @author user
 */
public class SKTVp20YearsWeather {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 12; i++) {
            //Задаем диапазоны по температуре и длинну месяцев в днях
            switch (i) {
                case 0: min= -30; max = -5; dayInMonth = 31; break;
                case 1: min= -25; max =  5; dayInMonth = 28; break;
            ...
            // Создаем внутренний массив длинной равной количеству дней в месяце
